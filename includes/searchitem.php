        ...
        <div class="card mb-3">
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    ...
                    <!-- <a class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#modalUpdateSItem[ITEMID]"> Update Details</a> -->
                    
                    <!-- <a class="btn btn-success" href="#" data-bs-toggle="modal" data-bs-target="#modalDeleteSItem[ITEMID]"> Add to Cart</a> -->
                    <form class="container row" method="post" action="api/addtocart.php">
                        <input type="number" class="form-control" name="cartqty" placeholder="1" value="1">
    ...
    <form method="post" action="api/login.php">
        ...
        <div class="modal-body">
            <div class="mb-3">
                ...
                <input type="hidden" name="itemid" value="[ITEMID]">
                <input type="number" class="form-control" id="input1" name="cartqty" placeholder="Enter quantity...">
            </div>
        </div>
...
<!-- UPDATE Menu Item -->
    <div class="modal fade" id="modalUpdateSItem[ITEMID]" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
        <div class="modal-content">
...
<!-- DELETE Menu Item -->
    <div class="modal fade" id="modalDeleteSItem[ITEMID]" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
